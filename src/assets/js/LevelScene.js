...
export default class LevelScene extends Phaser.Scene {
    ...
    preload ()
    {
        ...
        this.load.audio('flap','../src/assets/music/bird_flap.ogg');
        this.load.audio('shoot','../src/assets/music/bird_poo.ogg');
        this.load.audio('splat','../src/assets/music/bird_splat.ogg');

        this.load.audio('music1','../src/assets/music/cmusic1.ogg');
        this.load.audio('music2','../src/assets/music/cmusic2.ogg');
        this.load.audio('music3','../src/assets/music/cmusic3.ogg');
        this.load.audio('music4','../src/assets/music/jmusic1.ogg');
        this.load.audio('music5','../src/assets/music/jmusic2.ogg');
    ...
    create() {
        ...
        if(this.level==1) {
            ...
            this.player = new Player(this, 100,600,'hero',147);
            this.music = this.sound.add('music5', {loop: true, volume:0.4});        
        }
        ...
        this.flap = this.sound.add('flap', {loop: false, volume:2.0});
        this.shoot = this.sound.add('shoot', {loop: false, volume:2.0});
        this.splat = this.sound.add('splat', {loop: false, volume:2.0});
        ...
        this.carrotText = this.add.text(64, 16, 'carrots: 0', { fontSize: '32px', fill: '#f00' });
        this.carrotText.setScrollFactor(0, 0);
        this.carrotText.setDepth(4);

        this.horseCount = this.game.config.horse;
        this.horseText = this.add.text(64, 64, 'horseradishes: 0', { fontSize: '32px', fill: '#f00' });
        this.horseText.setScrollFactor(0, 0);
        this.horseText.setDepth(4);
...
*/
    ...
    createInput() {        
        ...
        this.wkey.on('down',this.doSpace.bind(this));



        this.shift = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.SHIFT);        
        this.shift.on('up', this.doEnter.bind(this));

        this.space = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.SPACE);
        this.space.on('up',this.doShoot.bind(this));

        this.ekey = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.E);
        this.ekey.on('down',this.useHorse.bind(this));
